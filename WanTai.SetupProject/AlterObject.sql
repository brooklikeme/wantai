...
INSERT [dbo].[RoleInfo] ([RoleID], [RoleName], [RoleModules], [RoleLevel]) VALUES (N'ce42a5ca-a334-4edc-8d05-75ce49d39473', N'Ô¶³Ì²Ù×÷Ô±', N'<Authority><MenuAuthority><Menu menuName="TabMainMenu" access="1" /><Menu menuName="btnNewExperiment" access="0" /><Menu menuName="CloseExperiment_button" access="0" /><Menu menuName="CloseLamp_button" access="0" /><Menu menuName="QueryExperiment_Button" access="1" /><Menu menuName="TabSettings" access="0" /><Menu menuName="PoolingRule_Button" access="0" /><Menu menuName="TestingItem_Button" access="0" /><Menu menuName="LiquidConfig_Button" access="0" /><Menu menuName="ReagentSuppliesConfig_Button" access="0" /><Menu menuName="Operation_Button" access="0" /><Menu menuName="TabUserManagement" access="0" /><Menu menuName="CreateUser_Button" access="0" /><Menu menuName="EditUser_Button" access="0" /><Menu menuName="EditPassword_Button" access="1" /><Menu menuName="OpenEVOware_Button" access="0" /><Menu menuName="TecanMaintainDay_Button" access="0" /><Menu menuName="TecanMaintainWeek_Button" access="0" /><Menu menuName="TecanMaintainMonth_Button" access="0" /><Menu menuName="TabHelp" access="1" /></MenuAuthority><DataAuthority><authority dataName="ExperimentHistory" access="All" /><authority dataName="UserInfo" access="All" /><authority dataName="LogInfo" access="All" /></DataAuthority></Authority>', 0)
GO
